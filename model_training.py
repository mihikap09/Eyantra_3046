...
train_dataset = datagen.flow_from_directory(
    'C://Users//devan//OneDrive//Desktop/training', target_size=(150, 150), batch_size=32, class_mode='categorical')

# Load and preprocess your validation data
validation_dataset = datagen.flow_from_directory(
    'C://Users//devan//OneDrive//Desktop/validation', target_size=(150, 150), batch_size=32, class_mode='categorical')
...
# Train the model on both the training and validation datasets
model.fit(
    train_dataset,
